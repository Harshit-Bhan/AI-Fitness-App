    ...
    <Toaster/>
      <div className='onboarding-container'>
        ...
        <div className='flex-1 px-6 onboarding-wrapper'>
            ...
            {step === 2 && (
              <div className='space-y-6 onboarding-wrapper'>
                ...
                <div className='flex flex-col gap-4 max-w-2xl'>
                  <Input label="Weight (kg)" type="number" className='max-w-2xl' value={formData.weight} onChange={(v) => updateField('weight',v)} placeholder='Enter your weight' min={10} max={300} required />
                  <Input label="Height (cm) - Optional" type="number" className='max-w-2xl' value={formData.height} onChange={(v) => updateField('height',v)} placeholder='Enter your height in cm' min={100} max={250} />
                </div>
            ...
            {step === 3 && (
              <div className='space-y-6 onboarding-wrapper'>
                ...
                <div className='space-y-8 max-w-lg'>
                  ...
                  <div className='space-y-6'>
                    <Slider label="Daily Calorie Intake " min={120} max={4000} step={40} value={formData.dailyCalorieIntake} onChange={(v) => updateField('dailyCalorieIntake', v)} unit='kcal' infoText="The total caloreis you plan to consume the next day." />
                    <Slider label="Daily Calorie Burn " min={100} max={2000} step={50} value={formData.dailyCalorieBurn} onChange={(v) => updateField('dailyCalorieBurn', v)} unit='kcal' infoText="The total caloreis you plan to burn through exercise and activity each day." />
                  </div>
                </div>
            ...
            {/* Navigation Buttons */}
          <div className="p-6 pt-8 onboarding-wrapper">
            <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
              ...
              {step > 1 && (
                <Button
                  ...
                  className="w-full sm:w-auto sm:px-10 h-11"
                >
