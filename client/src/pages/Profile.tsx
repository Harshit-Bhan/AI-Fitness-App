            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg transition-colors duration-200">
                <div className="size-10 rounded-lg bg-purple-100 dark:bg-purple-900/20 flex items-center justify-center">
                  <Scale className="size-4.5 text-purple-600 dark:tex-purple-400" />
                </div>
                <div>
      ...
      <div className="space-y-4">
        ...
        <Card className="p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* Food Entries */}
            <div className="text-center p-5 bg-emerald-50 dark:bg-emerald-900/10 rounded-xl border border-emerald-100 dark:border-emerald-900/30 hover:shadow-md transition">
            ...
            {/* Activities */}
            <div className="text-center p-5 bg-blue-50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-900/30 hover:shadow-md transition">
              <p className="text-sm text-slate-500 dark:text-slate-400">
          ...
          {/* Logout Button */}
          <Button className="w-full ring ring-red-300 hover:ring-2" variant="danger" onClick={logout}>
